        ...
        <div class="container p-3 my-3 border" style="background-color: white;">
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-import" role="tabpanel"
                    ...
                    <div class="card">
                        <form class="d-flex">
                            <input class="form-control me-2 w-25 col-sm-4" type="search" placeholder="Search">

                            <button class="btn btn-outline-success" type="submit">Search</button>
                            <label for="department" class="col-form-label col-sm">Department</label>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn-sm btn-info text-light" href="/pages/pay1.html">Edit</a>
                                        </td>
                                    <tr>
                                        <td>--</td>
                                        <td>--</td>
                                        ...
                                        <td>--</td>
                                        <td>
                                            <a class="btn-sm btn-info text-light" href="/pages/pay2.html">Edit</a>
                                        </td>
